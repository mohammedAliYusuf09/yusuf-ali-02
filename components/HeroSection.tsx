        ...
        <div className='flex w-full'>
            <div className='w-full md:w-[70%]'>
                ...
                <div className='flex gap-4 mt-8'>
                  ...
                  <a href='/sample-resume.pdf' download className='flex items-center bg-white text-black gap-2 px-5 py-3 rounded-full font-Outfit font-[300] text-base sm:text-lg md:text-xl border border-black'  >My resume <span><HiDownload /></span> </a>
                </div>
            </div>                                                                                                      
